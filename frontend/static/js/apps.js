...
const appsModule = {
    ...
    markAppsAsChanged: function() {
        ...
        if (currentApp) {
            ...
            if (appType) {
                ...
                // Also update the kyhuntarrUI tracking if available
                if (window.kyhuntarrUI && window.kyhuntarrUI.formChanged) {
                    window.kyhuntarrUI.formChanged[appType] = true;
                    window.kyhuntarrUI.hasUnsavedChanges = true;
                }
            }
        }
    ...
    saveApps: function(event) {
        ...
        if (!appType) {
            ...
            if (typeof kyhuntarrUI !== 'undefined' && typeof kyhuntarrUI.showNotification === 'function') {
                kyhuntarrUI.showNotification('Error: Could not determine which app settings to save', 'error');
            } else {
        ...
        if (!appPanel) {
            ...
            if (typeof kyhuntarrUI !== 'undefined' && typeof kyhuntarrUI.showNotification === 'function') {
                kyhuntarrUI.showNotification(`Error: App panel not found for ${appType}`, 'error');
            } else {
    ...
    saveAppSettings: function(appType, appPanel) {
        ...
        try {
            ...
            if (typeof kyhuntarrUI !== 'undefined' && typeof kyhuntarrUI.showNotification === 'function') {
                kyhuntarrUI.showNotification(`Error collecting settings: ${error.message}`, 'error');
            } else {
        ...
        .then(data => {
            ...
            if (typeof kyhuntarrUI !== 'undefined' && typeof kyhuntarrUI.showNotification === 'function') {
                kyhuntarrUI.showNotification(`${appType} settings saved successfully`, 'success');
            } else {
        ...
        .catch(error => {
            ...
            if (typeof kyhuntarrUI !== 'undefined' && typeof kyhuntarrUI.showNotification === 'function') {
                kyhuntarrUI.showNotification(`Error saving settings: ${error.message}`, 'error');
            } else {
