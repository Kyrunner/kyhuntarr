(function() {
    ...
    localStorage.setItem('kyhuntarr-dark-mode', 'true');
    ...
    localStorage.setItem('kyhuntarr-logo-url', LOGO_URL);
    
    // Create a global function to apply the logo to all logo elements
    window.applyLogoToAllElements = function() {
        const logoUrl = localStorage.getItem('kyhuntarr-logo-url') || LOGO_URL;
